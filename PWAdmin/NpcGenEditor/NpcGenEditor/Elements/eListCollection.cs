...
namespace NpcGenEditor.Elements
{
    public class eListCollection
    {
        MainWindow form1;
        public eListCollection(MainWindow form, string elFile, ref DevExpress.XtraEditors.ProgressBarControl pb)
        {
            this.form1 = form;
        ...
        /*void IndexOfLists(string list, int offset)
        {
            if (list.Contains("_ESSENCE"))
                Form1.indexOfItemEssence.Add(offset);
            if (list.Contains("PET_EGG_ESSENCE"))
                Form1.indexOfPetEggEssence = offset;
            if (list.Contains("PET_ESSENCE"))
                Form1.indexOfPetEssence = offset;
            if (list.Contains("FORCE_CONFIG"))
                Form1.indexOfForceConfig = offset;
        }*/
        ...
        public eList[] Load(string elFile, ref DevExpress.XtraEditors.ProgressBarControl pb)
        {
            ...
            if (configFiles.Length > 0)
            {
                ...
                pb.Position = 0;
                Console.WriteLine("Carregando arquivos data...");
                ...
                Console.WriteLine("elements carregado com sucesso!");

            }
            else
            {
                Console.WriteLine("No corressponding configuration file found!\nVersion: " + Version + "\nPattern: " + "configs\\PW_*_v" + Version + ".cfg");
            }
