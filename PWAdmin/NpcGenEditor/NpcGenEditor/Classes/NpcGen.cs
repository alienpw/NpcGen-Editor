...
{
    public class NpcMonster : IComparable<NpcMonster>
    {
        public int id { get; set; }
        public string name { get; set; }

        public int CompareTo(NpcMonster other)
        {
    ...
    public class ClassDefaultMonsters
    {
        ...
        public List<ClassExtraMonsters> MobDops = new List<ClassExtraMonsters>();
    }
    ...
    public class ClassDefaultResources
    {
        ...
        public int Trigger_id;
        public int IMaxNum;
        public List<ClassExtraResources> ResExtra = new List<ClassExtraResources>();
    }
    ...
    {
        public ClassPosition(float X, float Y, float Z, float DX, float DY, float DZ)
        {
            this.PosX = X;
            this.PosY = Y;
            this.PosZ = Z;
    ...
    {
        public IntDictionary(int Error, int Grid)
        {
            this.ErrorInex = Error;
            this.GridIndex = Grid;
        }
        public int ErrorInex;
